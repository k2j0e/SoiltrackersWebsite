...
export const metadata: Metadata = {
  title: "Terms of Service | Soiltrackers Solutions Inc.",
  description: "Terms of Service governing the use of the Soiltrackers software platform, soil marketplace, and related services.",
};
        ...
        <article className={styles.container}>
          <header className={styles.header}>
            ...
            <div className={styles.draftNotice}>
              <strong>DRAFT FOR LEGAL REVIEW.</strong> This is a working draft prepared for transparency and commercial governance, not formal legal advice. It governs the use of the Soiltrackers platform, mobile telematics integrations, and soil marketplace.
            </div>
          </header>
          ...
          <div className={styles.content}>
            <section className={styles.section}>
              ...
              <p>
                These Terms of Service (&ldquo;Terms&rdquo;) constitute a binding agreement between you (&ldquo;Customer&rdquo;, &ldquo;you&rdquo;) and Soiltrackers Solutions Inc. (&ldquo;Soiltrackers&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;), a company incorporated in British Columbia, Canada.
              </p>
              <p>
                By accessing or using this website, creating an account, or using the Soiltrackers platform or marketplace, you agree to be bound by these Terms and our <Link href="/privacy">Privacy Policy</Link>. If you are accessing the service on behalf of an entity, you represent and warrant that you have the authority to bind that entity to these Terms.
              </p>
            </section>
            ...
            <section className={styles.section}>
              <h2>2. The Service</h2>
              <p>
                Soiltrackers provides a cloud-based software system for soil chain-of-custody tracking, hauling dispatch coordination, environmental documentation management, and surplus soil exchange (&ldquo;the Platform&rdquo;).
              </p>
              <p>
            ...
            <section className={styles.section}>
              ...
              <p>
                <strong>The Confirmation Model:</strong> Soiltrackers uses GPS and geofencing to detect trip activity and assemble draft custody records as soil moves. You acknowledge and agree that custody records require user confirmation by authorized personnel to be verified and sealed. Soiltrackers does not warrant that undetected movements will be automatically captured without authorized review.
              </p>
              <p>
            ...
            <section className={styles.section}>
              ...
              <p>
                Soiltrackers is a software and documentation tool. <strong>Soiltrackers is not an environmental consultant, qualified professional (QP), laboratory, or regulatory agency.</strong>
              </p>
              <p>
            ...
            <section className={styles.section}>
              ...
              <p>
                The Soiltrackers marketplace provides a venue for verified participants to identify potential soil matches by classification, volume, and hauling distance.
              </p>
              <p>
                Transactions arranged through the marketplace are contracts directly between the participating generator and receiver. Soiltrackers is not a party to those transactions and does not guarantee the chemical composition, geotechnical suitability, or physical delivery of matched material.
              </p>
            </section>
            ...
            <section className={styles.section}>
              ...
              <p>
                Soiltrackers connects with supported third-party GPS and telematics providers where APIs permit. System performance and real-time tracking depend on continuous cellular network coverage, GPS satellite availability, and proper hardware installation.
              </p>
            </section>
            ...
            <section className={styles.section}>
              ...
              <p>
                <strong>Soiltrackers IP:</strong> Soiltrackers retains all right, title, and interest in and to the Platform, including software code, user interface designs, algorithms, logos, and documentation.
              </p>
              <p>
                <strong>Customer Data:</strong> You retain ownership of all project data, laboratory reports, site photographs, and manifest details you upload. You grant Soiltrackers a limited license to host, process, and display such data solely to provide the services and generate requested exports.
              </p>
            </section>
            ...
            <section className={styles.section}>
              ...
              <p>
                To the maximum extent permitted by law, Soiltrackers Solutions Inc. shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including loss of profits, project downtime, regulatory fines, or environmental remediation costs arising out of or related to your use of the Platform.
              </p>
              <p>
                Our total cumulative liability for all claims arising under these Terms shall not exceed the total fees paid by you to Soiltrackers in the twelve (12) months preceding the incident giving rise to liability.
              </p>
            </section>
